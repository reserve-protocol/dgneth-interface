...
const faqItems = [
  ...
  },
  {
    ...
    content: (
      <Box>
        The yield earned by staked Degen ETH (sdgnETH) is generated from the
        underlying yield strategies that comprise dgnETH’s collateral basket and
        boosted by the two-token model. The entirety of the yield generated by
        dgnETH’s collateral basket accrues to the staking contract — therefore
        the higher the supply of dgnETH relative to sdgnETH, the higher the
        staking yield will be. The underlying yield strategies backing dgnETH
        can be audited onchain at any time{' '}
        <Link
          href="https://app.reserve.org/ethereum/token/0x005f893ecd7bf9667195642f7649da8163e23658/overview"
          target="_blank"
          sx={{ display: 'inline', color: 'gray' }}
  ...
  },
  {
    ...
    content: (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        <Box>
          The Reserve protocol is a free, permissionless platform on Ethereum
          mainnet, Base, and Arbitrum to build, deploy, and govern asset-backed
          currencies called “RTokens.” RTokens are always 1:1 asset-backed,
          allowing for permissionless minting and redemptions onchain.
        </Box>
        <Box>
        ...
        <Box>
          ...
          collectively for over a year now with no security incidents. Nine{' '}
          <Link
        ...
        <Box>
          dgnETH is an RToken built on the Reserve protocol and governed by RSR
